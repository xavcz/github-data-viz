...
export const filterEmpty = repositories => repositories.filter(repo => repo.issues && repo.pullRequests);
...
const formatRepositoriesData = repositories => sortDescByKey('issues')(filterEmpty(flattenData(repositories)));
